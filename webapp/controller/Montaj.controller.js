sap.ui.define([
	...
	return BaseController.extend("com.bozankaya.ZBZ_MALZEME_NAKIL.controller.Montaj", {
		formatter: formatter,
		...
		onMontajBtn : function (oEvent) {
			var that = this;

			var oModel = this.getModelAndSetHeaders("ZBZ_MALZEME_NAKIL_SRV");
			var oObject = oEvent.getSource().getBindingContext().getObject();
			var sPath = "/MontajSet('" + oObject.Formno + "')";
			var oEntry = {};
