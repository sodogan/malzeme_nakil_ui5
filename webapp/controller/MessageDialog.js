sap.ui.define([
	...
	return BaseController.extend("com.bozankaya.ZBZ_MALZEME_NAKIL.controller.MessageDialog", {

		_getDialog: function () {
			if (!this.MessageDialog) {
				this.MessageDialog = sap.ui.xmlfragment(this.oView.getId(), "com.bozankaya.ZBZ_MALZEME_NAKIL.view.MessageDialog",
					this);
			}
