sap.ui.define([
	...
	return BaseController.extend("com.bozankaya.ZBZ_MALZEME_NAKIL.controller.PersonelValueHelp", {
		...
		_getDialog: function() {
			if (!this.oPersonelValueHelp) {
				this.oPersonelValueHelp = sap.ui.xmlfragment("com.bozankaya.ZBZ_MALZEME_NAKIL.view.PersonelValueHelp", this);
			}
