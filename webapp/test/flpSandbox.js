      ...
      services: {
                  ...
                  tiles: [
                    {
                      ...
                      properties: {
                        title: "Test App",
                        targetURL: "#combozankayaZBZ_MALZEME_NAKIL-display",
                      },
                    },
                  ],
                },
        ...
        ClientSideTargetResolution: {
          adapter: {
            config: {
              inbounds: {
                "combozankayaZBZ_MALZEME_NAKIL-display": {
                  semanticObject: "combozankayaZBZ_MALZEME_NAKIL",
                  action: "display",
                  ...
                  resolutionResult: {
                    ...
                    additionalInformation:
                      "SAPUI5.Component=com.bozankaya.ZBZ_MALZEME_NAKIL",
                    url: sap.ui.require.toUrl(
                      "com/bozankaya/ZBZ_MALZEME_NAKIL"
                    ),
                  },
                },
              },
